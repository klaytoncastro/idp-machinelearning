...
## 7. Conclusão
 ...
 Vimos tarefas importantes no campo de Processamento de Linguagem Natural (NLP) é uma área que ensina as máquinas a entender e responder ao texto humano, tais como: descobrir o sentimento de um texto (positivo, negativo ou neutro), classificar textos em categorias e gerar respostas automáticas. Usando técnicas como TF-IDF e modelos de linguagem modernos (transformers), podemos transformar textos em dados numéricos adequados ao processamento pela máquina. Com isso, é possível criar aplicações que analisam, interpretam e interagem com o usuário, como em assistentes virtuais ou sistemas de recomendação, aplicando NLP de forma prática. 